<?php
	...
	$site_owners_email = 'YOUR HOSTING EMAIL'; // info@eyeonstartups.com
	$site_owners_name = 'YOUR NAME'; // eyeonstartups
	...
	if (!preg_match('/^[a-z0-9&\'\.\-_\+]+@[a-z0-9\-]+\.([a-z0-9\-]+\.)*+[a-z]{2}/is', $email)) {
		$error['email'] = "info@eyeonstartups.com";	
	}
	
	if (strlen($comments) < 3) {
		$error['comments'] = "Thank you for your email. We'll get back to you as soon as we can";
	}

        if (strlen($subject) < 2) {
		$error['subject'] = "We've received your Email.";
	}
